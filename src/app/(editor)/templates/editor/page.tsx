...
export default async function TemplateEditorPage({
  ...
  const selectedTemplateId =
    ...
    templatesRaw.some((template) => template.id === resolvedSearchParams.templateId)
      ? resolvedSearchParams.templateId
      : templatesRaw[0]?.id;
  ...
  const activeProjectId = selectedTemplate?.project_id ?? templatesRaw[0]?.project_id ?? "";
  ...
  return (
    <div className="w-full">
      <header className="flex h-14 items-center justify-between border-b border-gray-200 bg-white px-6 dark:border-white/10 dark:bg-gray-900">
