...
export default async function ProjectTemplatesPage({
  ...
  function createSortHref(nextSortBy: SortBy, nextSortDir: SortDir) {
    ...
    return `/projects/${id}/templates${paramsValue.toString() ? `?${paramsValue.toString()}` : ""}`;
  }
  ...
  function createPageHref(nextPage: number) {
    ...
    return `/projects/${id}/templates?${paramsValue.toString()}`;
  }
                        ...
                        >
                          ...
                          <span
                            className={`inline-flex w-3 items-center justify-center ${
                              currentSortDirFor(column, normalizedSortBy, normalizedSortDir) !== "none"
                                ? "text-indigo-600 dark:text-indigo-300"
                                : "text-gray-500 dark:text-gray-400"
                            }`}
                          >
                            {currentSortDirFor(column, normalizedSortBy, normalizedSortDir) === "none" ? null : (
                              <ChevronUpIcon
